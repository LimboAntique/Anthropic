...
WRITEUP.txt     the short design note: approach, decisions and tradeoffs, iterations, learnings
PLAN.md         the plan the agents worked from, with the shared TODO table
