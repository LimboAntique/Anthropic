...
export function advise(p: Params, o: Outputs): Advice[] {
  ...
  add('warn', o.staleRate > 0.01 && o.staleRate <= 0.1, 'Some reads are stale', () => `${pct(o.staleRate)} of reads are out of date. Whether that is acceptable depends on the data; the TTL is the knob.`)
