...
export const PRESETS = [
  ...
  preset('Uniform access', 'Every key is equally likely, so the cache almost never hits and each miss pays Redis on top of the database: a net slowdown', { alpha: 0.1, wps: 1 }, { memGB: 0.25, ttlSec: 600 }),
