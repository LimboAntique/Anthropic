...
WRITEUP.md      the short design note: approach, decisions and tradeoffs, iterations, learnings
PLAN.md         the plan the agents worked from, with the shared TODO table; VIDEO.md is the video outline and script
claude_code_conversation/   transcripts of the five agent sessions: main (planning, contract, model, integration), mascot, page style research, simulator verification, UI
```
